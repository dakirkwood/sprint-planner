...
# - Consolidated all enums from various schema files
# - Renamed ValidationStatus to AdfValidationStatus and FileValidationStatus
# - Added TaskType, TaskStatus, JiraUploadStatus, EventCategory, AuditLevel enums
...
# =============================================================================
# VALIDATION ENUMS (Renamed to avoid conflicts)
# =============================================================================
...
class BaseResponse(BaseModel):
    ...
    request_id: Optional[str] = None  # For debugging and correlation
...
class ErrorResponse(BaseModel):
    ...
    technical_details: Optional[dict] = None  # Only populated when APP_DEBUG_MODE=true
    error_code: Optional[str] = None  # Application-specific error codes
