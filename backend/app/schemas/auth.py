...
from app.schemas.base import BaseRequest, BaseResponse, SessionStage
...
class IncompleteSessionsResponse(BaseResponse):
    """Response containing list of incomplete sessions."""
